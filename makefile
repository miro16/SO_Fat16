...
# Znacznik czasowy: 2024-01-18 22:15:12.267582
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -D_GNU_SOURCE -Wextra -std=c11 -DINSIDE_DANTE -D_ANSI_OUTPUT -fdiagnostics-color -Wno-error=unused-parameter -Wno-error=implicit-fallthrough -Wno-parentheses -Werror -fmax-errors=5 -Wno-error=parentheses -Werror=vla -Wall -pedantic -ggdb3 -xc 
